...
-The $dumpvars system task in Verilog is used to specify which variables and hierarchy levels should be recorded in a Value Change Dump (VCD) file for later waveform analysis. It is typically used in conjunction with $dumpfile, which specifies the filename for the abstract code with instantiated logic gates and flip-flops. tool used - yosys.
...
RTL - behavioural representaion of required specification
...
$abc -liberty ../my_lib/lib/sky130_fd_sc_hd__tt_025C_1v80.lib //This command converts RTL code into gates,cells which is taken from the sky130_fd_sc_hd__tt_025C_1v80.lib file.
